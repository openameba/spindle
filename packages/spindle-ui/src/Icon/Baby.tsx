...
const SvgBaby = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 11.9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3m5 2.3c-.5.7-1.2 1-2 1s-1.6-.4-2-1c-.3-.4-.9-.5-1.3-.2s-.5.9-.2 1.3c.8 1 2.1 1.7 3.5 1.7s2.7-.7 3.5-1.8c.3-.4.2-1-.2-1.3-.4-.2-1-.1-1.3.3m1-2.3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3" />
