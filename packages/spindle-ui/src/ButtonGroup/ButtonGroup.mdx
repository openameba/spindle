...
import buttonLayoutVertical from './button-layout-vertical.png';
import buttonLayoutHorizontal from './button-layout-horizontal.png';
...
<img src={buttonLayoutVertical} alt="縦並びのボタン配置例：Containedが上、Outlinedが下" />

### 横に並べる場合

Outlinedボタンを**左**に配置します。

<img src={buttonLayoutHorizontal} alt="横並びのボタン配置例：Outlinedが左、Containedが右" />
