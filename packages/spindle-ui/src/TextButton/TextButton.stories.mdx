...
<Source
  language='javascript'
  code={`import { TextButton } from '@openameba/spindle-ui'`}
/>
...
<Preview withSource="open">
  <Story name="Normal">
    <TextButton {...actions('onClick', 'onMouseOver')}>Text Link</TextButton>
  </Story>
</Preview>

<Source
  code={`
<TextButton>Text Link</TextButton>
  `}
/>
...
<Source
  language='html'
  code={`
<button class="spui-TextButton">Text Button</button>
  `}
/>
...
<div class="container">
<ul>
  <li><a class="spui-TextButton">Text Button</a></li>
</ul>
</div>
  `}
/>
