...
export const POSES: PoseConfig[] = [
  ...
  },
  {
    ...
    bodySubdir: 'body-bow',
    legSubdir: 'leg-standing',
    defaultHeadBodySwap: true,
    layers: [
      { part: 'leg', x: -3, y: 295, width: 300, height: 400 },
      { part: 'body', x: -3, y: 146, width: 300, height: 250 },
      { part: 'head', x: 18, y: -3.2, width: 180, height: 170, rotation: -12, pivotX: 108, pivotY: 81.8 },
      { part: 'beard', x: 67.1, y: 115.9, width: 75, height: 48, rotation: -12, pivotX: 104.6, pivotY: 139.9 },
      { part: 'mask', x: 58.4, y: 90.0, width: 96, height: 65, rotation: -12, pivotX: 106.4, pivotY: 122.5 },
      { part: 'glasses', x: 55.3, y: 79.3, width: 86, height: 49, rotation: -12, pivotX: 98.3, pivotY: 103.8 },
      { part: 'hat', x: 8.5, y: 5.3, width: 160, height: 95, rotation: -12, pivotX: 88.5, pivotY: 52.8 },
    ],
  },
  {
    id: 'old',
