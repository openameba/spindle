---
description: Fix Storybook errors using Chrome DevTools MCP
allowed-tools: Read, Glob, Grep, Bash, mcp__chrome-devtools__*
---
...
1. **Check MCP Availability**
   ...
   - **If Chrome DevTools MCP is NOT configured:**
     - Display a clear error message to the user:
       ...
       1. Run: claude mcp add chrome-devtools npx chrome-devtools-mcp@latest
